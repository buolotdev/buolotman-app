    ...
    final statusSteps = [
      {
        ...
        'desc': 'Your dispute has been received.',
        'done': true,
        'active': false,
      },
      {
        'label': 'Under Review',
        'desc': 'Our team is reviewing the case.',
        'done': false,
        'active': true,
      },
      {
        'label': 'In Mediation',
        'desc': 'Both parties will be contacted.',
        'done': false,
        'active': false,
      },
      {
        'label': 'Final Resolution',
        'desc': 'A decision will be made and communicated.',
        'done': false,
        'active': false,
      },
    ];
