...
class NotificationsScreen extends StatelessWidget {
  ...
  List<Map<String, Object>> _itemsForRole(AppState appState, String role) {
    final firstTask = appState.openMarketplaceTasks.isNotEmpty
        ? appState.openMarketplaceTasks.first
        : null;
    final unreadMessage = appState.threads.isNotEmpty
        ? appState.threads.first
        : null;
