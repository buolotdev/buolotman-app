...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  final _specializationController = TextEditingController(
    text: 'Industrial Electrical Systems',
  );
  final _bioController = TextEditingController(
    text:
        'Certified technician with field experience in wiring, repairs, and compliance-ready installations.',
  );
    ...
    if (_currentStep == 1) {
      return Column(
        ...
        children: [
          ...
          const SizedBox(height: 20),
          _buildUploadBox(
            "Tax ID / VAT Certificate (Optional)",
      ...
      return Column(
        ...
        children: [
          ...
          _buildTextField(
            ...
            "e.g. Construction, IT, Electrical",
          ),
          const SizedBox(height: 20),
    ...
    if (_currentStep == 1) {
      ...
      return Column(
        ...
        children: [
          ...
          _buildTextField(
            _specializationController,
            "e.g. Industrial Electrical Systems",
          ),
          const SizedBox(height: 24),
