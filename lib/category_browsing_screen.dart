...
class _CategoryBrowsingScreenState extends State<CategoryBrowsingScreen> {
  ...
  List<String> _deriveCategories(AppState appState) {
    final names = appState.apiCategories
          ...
          return GestureDetector(
            onTap: () {
              ...
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) =>
                      ListingScreen(initialQuery: chip == 'All' ? null : chip),
                ),
              );
            },
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: const Color(0xFF001F3F).withOpacity(0.02),
                    blurRadius: 4,
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => ListingScreen(initialQuery: title),
                    ),
                  );
                },
                child: Container(
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: const Color(0xFF001F3F).withOpacity(0.04),
                        blurRadius: 12,
