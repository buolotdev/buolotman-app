...
class BrowseProfessionalsScreen extends StatefulWidget {
  ...
  @override
  State<BrowseProfessionalsScreen> createState() =>
      _BrowseProfessionalsScreenState();
}
    ...
    return GetBuilder<AppState>(
      builder: (appState) {
        final List<String> categories = [
          'All',
          ...appState.apiCategories.map((c) => c['name'].toString()),
        ];
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 4),
                        Text(
                          user['country']?.toString().isNotEmpty == true
