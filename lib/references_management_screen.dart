...
class ReferencesManagementScreen extends StatefulWidget {
  ...
  @override
  State<ReferencesManagementScreen> createState() =>
      _ReferencesManagementScreenState();
}

class _ReferencesManagementScreenState
    extends State<ReferencesManagementScreen> {
    ...
    try {
      ...
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Error loading references: \$e')),
        );
    } finally {
  ...
  Future<void> _addReference() async {
    ...
    try {
      ...
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Reference added successfully for internal review.'),
          ),
        );
    } catch (e) {
      if (mounted)
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Error adding reference: \$e')));
    } finally {
  ...
  Future<void> _deleteReference(int id) async {
    try {
      ...
      if (mounted)
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Error deleting reference: \$e')),
        );
    }
  }
                        ...
                        children: [
                          TextFormField(
                            decoration: InputDecoration(
                              labelText: 'Previous Employer / Client Name',
                              filled: true,
                          ...
                          TextFormField(
                            decoration: InputDecoration(
                              labelText: 'Reference Person Name',
                              filled: true,
                              fillColor: const Color(0xFFF8FAFC),
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(8),
                          ...
                          TextFormField(
                            decoration: InputDecoration(
                              labelText:
                                  'Relationship (e.g. Supervisor, Client)',
                              filled: true,
                              fillColor: const Color(0xFFF8FAFC),
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(8),
                          ...
                          TextFormField(
                            decoration: InputDecoration(
                              labelText:
                                  'Document/Recommendation Letter URL (Optional)',
                              filled: true,
                              fillColor: const Color(0xFFF8FAFC),
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(8),
