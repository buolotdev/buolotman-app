...
class ProjectsContractsScreen extends StatefulWidget {
  ...
  @override
  State<ProjectsContractsScreen> createState() =>
      _ProjectsContractsScreenState();
}
...
class _ProjectsContractsScreenState extends State<ProjectsContractsScreen>
    ...
    return GetBuilder<AppState>(
      builder: (appState) {
        ...
        final active = projects
            .where((p) => (p['status'] ?? 'active') == 'active')
            .toList();
  ...
  Widget _buildProjectCard(
    ...
    final milestonesTotal =
        int.tryParse(project['milestones_total']?.toString() ?? '0') ?? 0;
    final milestonesCompleted =
...
class _ProjectDetailSheetState extends State<_ProjectDetailSheet> {
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  widget.appState.currentRole == 'Company'
                                      ? 'Client: $clientName'
                                  ...
                                  onPressed: () {
                                    ...
                                    if (existingThreadId == null) {
                                      widget.appState.createOrOpenThread(
                                        ...
                                        otherPartyImage: '',
                                        initialMessage:
                                            'Hi $otherName, let\'s chat about contract: "$title".',
                                      );
                                    }
  ...
  Widget _buildMilestoneTracker(int completed, int total, String projectId) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: const Color(0xFFF8FAFC),
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  onPressed: completed <= 0 || _isUpdating
                      ? null
                      : () =>
                            _updateMilestones(projectId, completed - 1, total),
                  style: OutlinedButton.styleFrom(
                    foregroundColor: const Color(0xFF001F3F),
          ...
          if (current == 'awaiting')
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: completed == total && total > 0
                ...
                onPressed: _isUpdating || completed < total || total == 0
                    ? null
                    : () async {
                        setState(() => _isUpdating = true);
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              margin: EdgeInsets.only(
                right: opt['key'] != 'completed' ? 8.0 : 0.0,
              ),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              const Text(
                'Create a long-term contract for a client project.',
