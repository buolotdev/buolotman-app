...
class _PortfolioManagementScreenState extends State<PortfolioManagementScreen> {
  ...
  final TextEditingController _servicePerformedController =
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Client/Company Worked For',
                          filled: true,
                          border: OutlineInputBorder(),
                        ),
                      ),
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: const InputDecoration(
                                labelText: 'Completed Date (YYYY-MM-DD)',
                                filled: true,
                                border: OutlineInputBorder(),
                              ),
                            ),
                          ...
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: _pickedBeforeImage == null
                                    ? Colors.grey[200]
                                    : Colors.green[100],
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (item['service_performed'] != null &&
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    "Service: \${item['service_performed']}",
                                    style: const TextStyle(fontSize: 14),
                                  ),
                                ),
                              if (item['client_company'] != null &&
                                  item['client_company'].toString().isNotEmpty)
                                Padding(
                                  padding: const EdgeInsets.only(bottom: 4),
                                  child: Text(
