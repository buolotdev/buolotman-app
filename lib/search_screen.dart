        ...
        final serviceMatches = appState.searchResults
            ...
            .map<ServiceItem>((s) {
              ...
              return ServiceItem(
                id: s['id']?.toString() ?? '',
                title: s['name'] ?? '',
                category: s['category'] is Map
                    ? (s['category']['name'] ?? 'General')
                    : (s['category']?.toString() ?? 'General'),
        ...
        children: [
          ...
          OutlinedButton(
            onPressed: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => const CategoryBrowsingScreen(),
                ),
              );
            },
            ...
            (item) => GestureDetector(
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) =>
                        ListingScreen(initialQuery: item['target'] as String),
                  ),
                );
              },
              child: Container(
