          ...
          builder: (appState) {
            ...
            final tasks = appState.openMarketplaceTasks.where((task) {
              ...
              if (_budgetFilter != 'Any') {
                ...
                if (_budgetFilter == '\$50–\$200' && (b < 50 || b > 200))
                  return false;
                if (_budgetFilter == '\$200–\$500' && (b < 200 || b > 500))
                  return false;
                ...
                child: Column(
                  children: [
                    ...
                    Showcase(
                      key: _tourKey1,
                      description:
                          'Search for jobs by title, category, or location.',
                    ...
                    Expanded(
                      child: Showcase(
                        key: _tourKey2,
                        description:
                            'These are live tasks posted by clients. Tap one to read the full details and place a bid.',
      ...
      child: Row(
        children: [
          ...
          Showcase(
            key: _tourKey3,
            description:
                'Filter tasks by your specific requirements and budget.',
            child: Stack(
              children: [
                IconButton(
      ...
      onTap: () {
        () async {
          ...
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => BrowseTasksScreen(taskId: taskId),
            ),
          );
        }();
      },
