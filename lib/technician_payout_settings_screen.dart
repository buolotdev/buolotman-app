...
class TechnicianPayoutSettingsScreen extends StatefulWidget {
  ...
  @override
  State<TechnicianPayoutSettingsScreen> createState() =>
      _TechnicianPayoutSettingsScreenState();
}

class _TechnicianPayoutSettingsScreenState
    extends State<TechnicianPayoutSettingsScreen> {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Your financial details remain completely private and are used only for Boulot Man payouts.',
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Bank Account', 'Mobile Money']
