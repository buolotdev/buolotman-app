...
class TechnicianPublicProfileScreen extends StatefulWidget {
  ...
  @override
  State<TechnicianPublicProfileScreen> createState() =>
      _TechnicianPublicProfileScreenState();
}

class _TechnicianPublicProfileScreenState
    extends State<TechnicianPublicProfileScreen>
  ...
  Widget build(BuildContext context) {
    ...
    final int reviewsVal =
        int.tryParse(dataMap['completed_jobs']?.toString() ?? '') ?? 0;
    ...
    final double hourlyRateVal =
        double.tryParse(dataMap['hourly_rate']?.toString() ?? '') ?? 0.0;
    final double dailyRateVal =
        double.tryParse(dataMap['daily_rate']?.toString() ?? '') ?? 0.0;
    final double fixedPriceVal =
              ...
              Expanded(
                child: TabBarView(
                  ...
                  children: [
                        ...
                        _isLoading
                            ...
                            : Text(
                                experience.isNotEmpty
                                    ? experience
                                    : 'No specific experience documented.',
                                style: const TextStyle(
                                  fontSize: 14,
                                  color: Color(0xFF64748B),
                                  height: 1.6,
                    ...
                    ListView(
                      ...
                      children: [
                        ...
                        if (_isLoading)
                          ...
                          _buildToggleRow(
                            'BM Concierge',
                            dataMap['bm_concierge'] == true ||
                                dataMap['bm_concierge'] == 'true',
                          ),
                          _buildToggleRow(
                            'BM Build a Team',
                            dataMap['bm_build_team'] == true ||
                                dataMap['bm_build_team'] == 'true',
                          ),
                          _buildToggleRow(
                            'BM Emergency',
                            dataMap['bm_emergency'] == true ||
                                dataMap['bm_emergency'] == 'true',
                          ),
                          _buildToggleRow(
                            'Open to BM Contractor Projects',
                            dataMap['bm_contractor_projects'] == true ||
                                dataMap['bm_contractor_projects'] == 'true',
                          ),
                          _buildToggleRow(
                            'Can Supervise Technicians',
                            dataMap['can_supervise'] == true ||
                                dataMap['can_supervise'] == 'true',
                          ),
                          _buildToggleRow(
                            'Has Team Leader Experience',
                            dataMap['team_leader_experience'] == true ||
                                dataMap['team_leader_experience'] == 'true',
                          ),
                          _buildToggleRow(
                            'Has Project Management Experience',
                            dataMap['project_management_experience'] == true ||
                                dataMap['project_management_experience'] ==
                                    'true',
                          ),
                        ],
                      ],
                    ...
                    ListView(
                      padding: const EdgeInsets.all(20.0),
                      children: [_buildPortfolioSection(dbPortfolio)],
                    ),

                    // Tab 4: Reviews
                    ListView(
                      padding: const EdgeInsets.all(20.0),
                      children: [_buildReviewsSection(dbReviews)],
                    ),
                      ...
                      children: [
                        ...
                        if (_isLoading)
                          ...
                          _buildToggleRow(
                            ...
                            dataMap['available_now'] == true ||
                                dataMap['available_now'] == 'true',
                          ),
                          _buildToggleRow(
                            'Accepts Individual Jobs',
                            dataMap['accepts_individual_jobs'] == true ||
                                dataMap['accepts_individual_jobs'] == 'true',
                          ),
                          _buildToggleRow(
                            'Accepts Team Projects',
                            dataMap['accepts_team_projects'] == true ||
                                dataMap['accepts_team_projects'] == 'true',
                          ),
                          _buildToggleRow(
                            'Accepts Long Term Contracts',
                            dataMap['accepts_long_term_contracts'] == true ||
                                dataMap['accepts_long_term_contracts'] ==
                                    'true',
                          ),
                          _buildToggleRow(
                            'Accepts Short Term Jobs',
                            dataMap['accepts_short_term_jobs'] == true ||
                                dataMap['accepts_short_term_jobs'] == 'true',
                          ),
                          _buildToggleRow(
                            'Interested in Long Term Placement',
                            dataMap['interested_in_long_term_placement'] ==
                                    true ||
                                dataMap['interested_in_long_term_placement'] ==
                                    'true',
                          ),
                          _buildToggleRow(
                            ...
                            dataMap['accepts_onsite'] != false &&
                                dataMap['accepts_onsite'] != 'false',
                          ),
                          _buildToggleRow(
                            'Accepts Remote Work',
                            dataMap['accepts_remote'] == true ||
                                dataMap['accepts_remote'] == 'true',
                          ),
                          _buildToggleRow(
                            'Accepts Weekend Work',
                            dataMap['accepts_weekends'] == true ||
                                dataMap['accepts_weekends'] == 'true',
                          ),
                          _buildToggleRow(
                            'Accepts Emergency Jobs',
                            dataMap['accepts_emergency'] == true ||
                                dataMap['accepts_emergency'] == 'true',
                          ),
                          _buildToggleRow(
                            'Available Full-time',
                            dataMap['accepts_full_time'] == true ||
                                dataMap['accepts_full_time'] == 'true',
                          ),
                          _buildToggleRow(
                            'Available Part-time',
                            dataMap['accepts_part_time'] != false &&
                                dataMap['accepts_part_time'] != 'false',
                          ),
                          const Divider(),
                          _buildToggleRow(
                            'Willing to Travel',
                            dataMap['willing_to_travel'] == true ||
                                dataMap['willing_to_travel'] == 'true',
                          ),
                          if (dataMap['willing_to_travel'] == true ||
                              dataMap['willing_to_travel'] == 'true')
                            Padding(
              ...
              try {
                ...
                if (context.mounted) {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) =>
                          ChatScreen(name: widget.name, image: widget.avatar),
                    ),
                  );
                }
              } catch (e) {
          ...
          child: Column(
            children: [
              ...
              _buildVerifItem(
                ...
                isVerified:
                    verificationBadge == 'Professional Verified' ||
                    verificationBadge == 'BM Verified Professional',
