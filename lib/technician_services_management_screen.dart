...
class TechnicianServicesManagementScreen extends StatefulWidget {
  ...
  @override
  State<TechnicianServicesManagementScreen> createState() =>
      _TechnicianServicesManagementScreenState();
}

class _TechnicianServicesManagementScreenState
    extends State<TechnicianServicesManagementScreen> {
  ...
  Future<void> _addService() async {
    ...
    try {
      await ApiService.instance.publishTechnicianService({
  ...
  Future<void> _removeService(int id) async {
    try {
      ...
      if (mounted)
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Error removing service: $e')));
    }
  }
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: _selectedService == null || _isAdding
                                ? null
                                : _addService,
