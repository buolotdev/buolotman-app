    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final String statusText =
            task['status']?.toString().toUpperCase() ?? 'OPEN';
        final double minB =
            double.tryParse(task['budget_min']?.toString() ?? '0') ?? 0;
        final double maxB =
            double.tryParse(task['budget_max']?.toString() ?? '0') ?? 0;
                        ...
                        onPressed: () async {
                          showDialog(
                            ...
                            builder: (ctx) => AlertDialog(
                              ...
                              content: const Text(
                                "Are you sure you want to cancel this task? This is irreversible.",
                              ),
                              actions: [
                                TextButton(
