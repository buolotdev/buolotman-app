...
class _PostTaskFormScreenState extends State<PostTaskFormScreen> {
  final _titleController = TextEditingController(
    text: "Fix a leaking kitchen sink pipe",
  );
  final _descriptionController = TextEditingController(
    text:
        "The pipe under the kitchen sink is leaking heavily and causing water damage to the cabinet. I need someone to come fix or replace it as soon as possible. I can provide pictures if needed.",
  );
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: _selectedCategory == cat
                          ? const Icon(Icons.check, color: Color(0xFFFF4500))
                          : null,
                      onTap: () {
                        setState(() {
  ...
  Future<void> _showTimelinePicker() async {
    ...
    if (picked != null) {
      ...
      final formatted =
          "By ${weekdays[picked.weekday % 7]}, ${months[picked.month - 1]} ${picked.day}";
      setState(() {
        _timeline = formatted;
                    ...
                    children: [
                      ...
                      _buildDropdownField(
                        ...
                        onTap: () {
                          ...
                          final subs =
                              _dynamicSubcategories[_selectedCategory] ?? [];
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          final detectedCountry =
                              appState.currentUser.country.isNotEmpty
                              ? appState.currentUser.country
                              : "Nigeria";
                          final detectedCity = detectedCountry == "Pakistan"
                              ? "Lahore"
  ...
  Widget _buildLocationTabs() {
    return Row(
      children: [
        Expanded(
          child: _buildLocationTab("On-site", Icons.location_on_outlined),
        ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Expanded(
                          child: _buildTextField(_minBudgetController, "Min"),
                        ),
                      ],
                    ),
                  ],
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Expanded(
                          child: _buildTextField(_maxBudgetController, "Max"),
                        ),
                      ],
                    ),
                  ],
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          ...
          final appState = Get.find<AppState>();
          final String userCountry = appState.currentUser.country.isNotEmpty
              ? appState.currentUser.country
              : 'Nigeria';
          final String userCity = userCountry == 'Pakistan'
              ? 'Lahore'
