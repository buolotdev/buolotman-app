...
class _EditCompanyProfileScreenState extends State<EditCompanyProfileScreen> {
  ...
  void initState() {
    ...
    _aboutCtrl = TextEditingController(
      text: profile['about']?.toString() ?? '',
    );
    _headquartersCtrl = TextEditingController(
      text: profile['headquarters']?.toString() ?? '',
    );
    _websiteCtrl = TextEditingController(
      text: profile['website']?.toString() ?? '',
    );
    _companySizeCtrl = TextEditingController(
      text: profile['company_size']?.toString() ?? '',
    );
    _industryCtrl = TextEditingController(
      text: profile['industry']?.toString() ?? '',
    );
