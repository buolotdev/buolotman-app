...
class _EditTaskScreenState extends State<EditTaskScreen> {
  ...
  void initState() {
    ...
    _budgetController = TextEditingController(
      text: widget.task.budget.toStringAsFixed(2),
    );
    ...
    _locationType = widget.task.tags.contains('Remote')
        ? 'Remote'
        : widget.task.tags.contains('Hybrid')
        ? 'Hybrid'
        : 'On-site';
    ...
    _selectedPaymentMethod = widget.task.paymentMethod.isNotEmpty
      ...
      showDialog(
        ...
        builder: (context) => const Center(
          child: CircularProgressIndicator(
            valueColor: AlwaysStoppedAnimation(Color(0xFFFF4500)),
          ),
        ),
      );
