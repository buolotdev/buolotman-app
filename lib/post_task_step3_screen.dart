        ...
        children: [
          ...
          GridView.count(
            ...
            children: [
              ...
              _buildInfoCard(
                "Type & Urgency",
                '${draft.locationType} (${draft.urgency})',
              ),
            ],
          ),
        ],
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              _buildPhotoItem(
                "https://storage.googleapis.com/banani-generated-images/generated-images/e7bcd2fb-cd81-46b2-84d7-7145885d2e66.jpg",
              ),
              const SizedBox(width: 12),
              _buildPhotoItem(
                "https://storage.googleapis.com/banani-generated-images/generated-images/c1331a10-1c33-4849-a713-151cb9b1f5a6.jpg",
              ),
              const SizedBox(width: 12),
              _buildPhotoItem(
                "https://storage.googleapis.com/banani-generated-images/generated-images/3948d46f-cc6c-4419-a395-442518fe4307.jpg",
              ),
            ],
          ),
        ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildRowItem(
            Icons.check,
            "Bring installation tools and safety gear",
          ),
          const SizedBox(height: 10),
          ...
          _buildRowItem(
            Icons.check,
            "Apartment access is available from 9:00 AM to 5:00 PM",
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildRowItem(
            Icons.map_outlined,
            "Job location and preferred appointment time",
          ),
          const SizedBox(height: 10),
          _buildRowItem(
            Icons.account_balance_wallet_outlined,
            "Budget range and hiring preference",
          ),
          const SizedBox(height: 10),
          _buildRowItem(
            Icons.image_outlined,
            "Reference photos and notes to clarify scope",
          ),
        ],
      ),
    );
          ...
          Expanded(
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                try {
                  final task = await AppStateScope.of(
                    context,
                  ).publishTask(draft);
                  if (context.mounted) {
                    ...
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) =>
                            PostTaskSuccessScreen(taskId: task.id),
                      ),
                    );
                  }
                } catch (e) {
