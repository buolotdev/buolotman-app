...
class _GoogleRoleSelectionScreenState extends State<GoogleRoleSelectionScreen> {
  ...
  Future<void> _submitProfile() async {
    ...
    try {
      final body = <String, dynamic>{'role': _selectedRole};
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? const Color(0xFFFF4500).withValues(alpha: 0.05)
              : Colors.white,
          border: Border.all(
            color: isSelected
                    ...
                    children: [
                      ...
                      if (_selectedRole == 'TECHNICIAN') ...[
                        ...
                        _buildTextField(
                          ...
                          "Hourly Rate",
                          "Enter your hourly rate (e.g. 25.00)",
                          Icons.attach_money,
                          isNumber: true,
                          isRequired: true,
                        ),
                      ...
                      if (_selectedRole == 'COMPANY') ...[
                        ...
                        _buildTextField(
                          ...
                          "Registration Number",
                          "Enter legal registration number",
                          Icons.numbers,
                          isRequired: true,
                        ),
                        _buildTextField(
