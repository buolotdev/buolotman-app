...
class ProfileScreen extends StatelessWidget {
    ...
    showDialog(
      ...
      builder: (_) => Dialog(
        ...
        child: InteractiveViewer(
          child: Image(
            image: getAvatarImageProvider(avatar),
            fit: BoxFit.contain,
          ),
        ),
      ),
                ...
                if (role == 'Technician') ...[
                  _buildSectionCard(
                    ...
                    children: [
                      ...
                      if (appState.currentUser.primaryOccupation.isNotEmpty)
                        _buildDetailRow(
                          'Occupation',
                          appState.currentUser.primaryOccupation,
                        ),
                      if (appState.currentUser.preferredLanguages.isNotEmpty)
                        _buildDetailRow(
                          'Languages',
                          appState.currentUser.preferredLanguages.join(', '),
                        ),
                      _buildDetailRow('Bio', appState.currentUser.bio),
                      _buildDetailRow(
                        'Verification',
                        appState.currentUser.verificationBadge,
                      ),
                    ],
                  ),
                  ...
                  _buildSectionCard(
                    ...
                    children: [
                      ...
                      Text(
                        appState.currentUser.experience.isNotEmpty
                            ? appState.currentUser.experience
                  ...
                  _buildSectionCard(
                    ...
                    children: [
                      if (appState.currentUser.certifications.isEmpty &&
                          appState.currentUser.licences.isEmpty)
                        const Text(
                        ...
                        if (appState.currentUser.certifications.isNotEmpty)
                          ...appState.currentUser.certifications.map(
                            (c) => Padding(
                              padding: const EdgeInsets.only(bottom: 6),
                              child: Row(
                                children: [
                        ...
                        if (appState.currentUser.licences.isNotEmpty)
                          ...appState.currentUser.licences.map(
                            (l) => Padding(
                              padding: const EdgeInsets.only(bottom: 6),
                              child: Row(
                                children: [
                  ...
                  _buildSectionCard(
                    ...
                    children: [
                      ...
                      _buildAvailabilityToggle(
                        ...
                        appState.currentUser.availableNow,
                      ),
                      _buildAvailabilityToggle(
                        'Accepts On-site Work',
                        appState.currentUser.acceptsOnsite,
                      ),
                      _buildAvailabilityToggle(
                        'Accepts Remote Work',
                        appState.currentUser.acceptsRemote,
                      ),
                      _buildAvailabilityToggle(
                        'Accepts Weekend Work',
                        appState.currentUser.acceptsWeekends,
                      ),
                      _buildAvailabilityToggle(
                        'Accepts Emergency Jobs',
                        appState.currentUser.acceptsEmergency,
                      ),
                      _buildAvailabilityToggle(
                        'Available Full-time',
                        appState.currentUser.acceptsFullTime,
                      ),
                      _buildAvailabilityToggle(
                        'Available Part-time',
                        appState.currentUser.acceptsPartTime,
                      ),
                      const Divider(),
                      _buildAvailabilityToggle(
                        'Willing to Travel',
                        appState.currentUser.willingToTravel,
                      ),
                  ...
                  _buildSectionCard(
                    ...
                    children: [
                      ...
                      if (appState.currentUser.startingPrice == 0 &&
                          appState.currentUser.hourlyRate == 0 &&
                          appState.currentUser.dailyRate == 0 &&
                          appState.currentUser.fixedPrice == 0 &&
                          appState.currentUser.inspectionFee == 0)
                        const Text(
                    ...
                    children: [
                      if (appState.currentUser.workPreferences.isEmpty)
                        ...
                        Wrap(
                          spacing: 8,
                          runSpacing: 8,
                          children: appState.currentUser.workPreferences.map((
                            s,
                          ) {
                            return Container(
                              padding: const EdgeInsets.symmetric(
                  ...
                  _buildSectionCard(
                    ...
                    children: [
                      _buildAvailabilityToggle(
                        'Has Own Tools',
                        appState.currentUser.ownTools,
                      ),
                      _buildAvailabilityToggle(
                        'Has Work Vehicle',
                        appState.currentUser.hasVehicle,
                      ),
                      if (appState
                          .currentUser
                          .toolsAndEquipment
                        ...
                        Wrap(
                          spacing: 8,
                          runSpacing: 8,
                          children: appState.currentUser.toolsAndEquipment.map((
                            s,
                          ) {
                            return Container(
                              padding: const EdgeInsets.symmetric(
                  ...
                  _buildSectionCard(
                    ...
                    children: [
                      _buildAvailabilityToggle(
                        'BM Concierge',
                        appState.currentUser.bmConcierge,
                      ),
                      _buildAvailabilityToggle(
                        'BM Build a Team',
                        appState.currentUser.bmBuildTeam,
                      ),
                      _buildAvailabilityToggle(
                        'BM Emergency',
                        appState.currentUser.bmEmergency,
                      ),
                      _buildAvailabilityToggle(
                        'Can Supervise Technicians',
                        appState.currentUser.canSupervise,
                      ),
                    ],
                  ),
                  const SizedBox(height: 16),
            ...
            child: CircleAvatar(
              ...
              backgroundImage:
                  (displayAvatar.isNotEmpty &&
                      !displayAvatar.contains('onboard'))
                  ? getAvatarImageProvider(displayAvatar)
                  : null,
              child:
                  (displayAvatar.isEmpty || displayAvatar.contains('onboard'))
              ...
              onPressed: () {
                if (role == 'Technician') {
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) =>
                          const TechnicianProfileSettingsScreen(),
                    ),
                  );
                } else {
          ...
          _buildTile(
            ...
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) =>
                      const TechnicianServicesManagementScreen(),
                ),
              );
            },
          ),
        ...
        if (role == 'Technician')
          _buildTile(
            ...
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => const ReferencesManagementScreen(),
                ),
              );
            },
          ),
        if (role == 'Technician')
          _buildTile(
            ...
            onTap: () {
              Navigator.of(context).push(
                MaterialPageRoute(
                  builder: (context) => const TechnicianPayoutSettingsScreen(),
                ),
              );
            },
          ),
  ...
  void _showEditProfileDialog(BuildContext context, AppState appState) {
    ...
    final countryController = TextEditingController(
      text: country.isNotEmpty ? country : 'Nigeria',
    );
                            ...
                            if (confirm == true) {
                              try {
                                ...
                                if (context.mounted) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Portfolio item deleted.'),
                                    ),
                                  );
                                }
                              } catch (e) {
  ...
  void _showAddPortfolioDialog(BuildContext context, AppState appState) {
    ...
    final catController = TextEditingController(
      text: appState.currentUser.skills.isNotEmpty
          ? appState.currentUser.skills.first
          : 'General',
    );
                  ...
                  onPressed: () async {
                    ...
                    try {
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Failed to add portfolio item: $e'),
                          ),
                        );
                      }
                    }
