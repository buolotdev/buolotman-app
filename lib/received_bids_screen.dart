        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) =>
                _buildBidCard(context, bids[index], taskId),
          );
        },
      ),
    );
                ...
                child: OutlinedButton(
                  onPressed: () {
                    final matchedPro = appState.publicPros.firstWhere(
                      (u) =>
                          u['id']?.toString() == bid.technicianId?.toString(),
                      ...
                      : () async {
                          ...
                          try {
                            ...
                            if (context.mounted) {
                              ...
                              Navigator.of(
                                context,
                              ).pop(); // Return to previous task view
                            }
                          } catch (e) {
                            if (context.mounted) {
                              Navigator.of(context).pop(); // Dismiss loading
